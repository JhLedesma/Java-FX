...
public class Histeria extends Escala
{
    @Override
    protected void iniciarItemsEscala()
    {
        ...
        itemsEscala.add(new ItemEscala(152, 0));
        ...
        itemsEscala.add(new ItemEscala(253, 0));
    ...
    protected void inicarPT() {
        ...
        puntajeTVaron.put(13,31);
        puntajeTVaron.put(14,33);
        puntajeTVaron.put(15,35);
        puntajeTVaron.put(16,37);
        puntajeTVaron.put(17,39);
        puntajeTVaron.put(18,41);
        puntajeTVaron.put(19,43);
        puntajeTVaron.put(20,45);
        ...
        puntajeTVaron.put(41,89);
        puntajeTVaron.put(42,91);
        puntajeTVaron.put(43,93);
        puntajeTVaron.put(44,95);
        puntajeTVaron.put(45,97);
        puntajeTVaron.put(46,99);
        puntajeTVaron.put(47,101);
        puntajeTVaron.put(48,103);
        puntajeTVaron.put(49,105);
        puntajeTVaron.put(50,107);
        puntajeTVaron.put(51,109);
        puntajeTVaron.put(52,111);
        puntajeTVaron.put(53,113);
        puntajeTVaron.put(54,115);
        puntajeTVaron.put(55,117);
        puntajeTVaron.put(56,119);

        puntajeTMujer.put(14,31);
        puntajeTMujer.put(15,33);
        puntajeTMujer.put(16,35);
        puntajeTMujer.put(17,37);
        puntajeTMujer.put(18,39);
        puntajeTMujer.put(19,41);
        puntajeTMujer.put(20,43);
        puntajeTMujer.put(21,45);
        puntajeTMujer.put(22,47);
        ...
        puntajeTMujer.put(35,74);
        puntajeTMujer.put(36,76);
        puntajeTMujer.put(37,78);
        puntajeTMujer.put(38,80);
        puntajeTMujer.put(39,82);
        puntajeTMujer.put(40,84);
        puntajeTMujer.put(41,86);
        puntajeTMujer.put(42,88);
        puntajeTMujer.put(43,90);
        puntajeTMujer.put(44,92);
        puntajeTMujer.put(45,94);
        puntajeTMujer.put(46,97);
        puntajeTMujer.put(47,99);
        puntajeTMujer.put(48,101);
        puntajeTMujer.put(49,103);
        puntajeTMujer.put(50,105);
        puntajeTMujer.put(51,107);
        puntajeTMujer.put(52,109);
        puntajeTMujer.put(53,111);
        puntajeTMujer.put(54,113);
        puntajeTMujer.put(55,115);
        puntajeTMujer.put(56,117);
        puntajeTMujer.put(57,119);
